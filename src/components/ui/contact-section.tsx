      ...
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1">
          ...
          <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl ">
            ...
            <textarea
              name="message"
              className="w-full h-24 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal resize-none  rounded-full border border-gray-200 focus:outline-none pl-4 mb-10"
              placeholder="Message"
